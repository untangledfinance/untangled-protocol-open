...
// import {SecuritizationPoolERC721Receiver} from './SecuritizationPoolERC721Receiver.sol';
...
//  */
// contract SecuritizationPoolFC is ISecuritizationPool, SecuritizationPoolERC721Receiver {
...
//         _exportAssets(tokenAddress, toPoolAddress, tokenIds);
//     }
...
//         _withdrawAssets(tokenAddresses, tokenIds, recipients);
//     }
...
//         uint256 expectedAssetsValue = _collectAssets(tokenAddress, from, tokenIds);

//         _amountOwedToOriginator += expectedAssetsValue;
...
//     function pause() public virtual override onlyPoolAdmin {
//         _pause();
//     }

//     function unpause() public virtual override onlyPoolAdmin {
//         _unpause();
//     }

//     function acceptedInvoiceToken() public view returns (address) {
//         return registry.getAcceptedInvoiceToken();
//     }

//     function loanAssetToken() public view returns (address) {
//         return registry.getLoanAssetToken();
//     }

//     function valueService() public view returns (address) {
//         return registry.getValueService();
//     }

//     function _setOpeningBlockTimestamp(uint64 newTimestamp) internal virtual {
//         openingBlockTimestamp = newTimestamp;
//         emit UpdateOpeningBlockTimestamp(newTimestamp);
//     }

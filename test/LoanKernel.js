...
describe('LoanKernel', () => {
  ...
  describe('#fillDebtOrder', async () => {
    it('upload loan successfully and receive LAT token', async function() {
      ...
      expect(await loanAssetTokenContract.balanceOf(originatorSigner.address)).to.equals(20)
    });

  });

  describe('#concludeLoans', async function() {
